function terceiragrili() {
    while (question != 1 || question != 2 || question  != 3) {
        ...
        if (question == 1) {
            window.location.href = "../Escolhas/Gri-li/gameovergrili3.html";
            break;
        } else if (question == 2) {
            window.location.href = "../Escolhas/Gri-li/vitoria.html";
            break;
        } else if (question == 3) {
            window.location.href = "../Escolhas/Gri-li/gameovergrili4.html";
            break;    
        } else {
